...
\textbf{\arabic{SyllabiSectionCount} Datos Generales}
...
\addtocounter{SyllabiSectionCount}{1}
\textbf{\arabic{SyllabiSectionCount} Exposición de Motivos}
\begin{tabularx}{\textwidth}{|X|}\hline
--JUSTIFICATION--
\\ \hline
\end{tabularx}

\textbf{\arabic{SyllabiSectionCount} Competencias}
\begin{tabularx}{\textwidth}{|X|} \hline
--GOAL--
\\ \hline
\end{tabularx}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\addtocounter{SyllabiSectionCount}{1}
\textbf{\arabic{SyllabiSectionCount} Contenido Temático}
\setcounter{SyllabiUnitCount}{0}
--BEGINUNIT--
% Inicio unidad
\addtocounter{SyllabiUnitCount}{1}
\textbf{\arabic{SyllabiSectionCount} --UNIT_TITLE-- (--HOURS--)}
...
\addtocounter{SyllabiSectionCount}{1}
\textbf{\arabic{SyllabiSectionCount} Actividades}
\begin{itemize}
\item Asignaciones
...
\addtocounter{SyllabiSectionCount}{1}
\textbf{\arabic{SyllabiSectionCount} Recursos Materiales}
\begin{itemize}
\item Apuntes del curso
\item Libro(s) de la bibliografiaTecnologia
\end{itemize}

\addtocounter{SyllabiSectionCount}{1}
\textbf{\arabic{SyllabiSectionCount} Metodología}
\begin{itemize}
...
\addtocounter{SyllabiSectionCount}{1}
\textbf{\arabic{SyllabiSectionCount} Evaluación}
...
%\addtocounter{SyllabiSectionCount}{1}
% \textbf{\arabic{SyllabiSectionCount} Recursos Bibliográficos}
