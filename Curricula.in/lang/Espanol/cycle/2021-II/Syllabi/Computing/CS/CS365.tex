...
\begin{justification}
La Computación Evolutiva comprende un conjunto de metodologías de búsqueda y optimización
cuya base primordial es el Paradigma Neodarwiniano que agrupa la Herencia Genética (Mendel), 
el Seleccionismo (Weismann) y la Evolución de las Especies (Darwin) que, 
cuando llevadas a implementaciones computacionales, ofrecen una herramienta poderosa de optimización global 
para una determinada función objetivo. 
Son bastante robustos cuando se supone la existencia de muchos óptimos locales. 
De esta forma, estos algoritmos pueden aplicarse en diversos problemas de optimización.
\end{justification}
...
\begin{unit}{Introducción a la Optimización}{}{weise09, Rozenberg:2012}{4}{a,b}
\begin{topics}
...
\begin{unit}{Computación Evolutiva: Conceptos básicos}{}{Rozenberg:2012,weise09,fogel95,koza98,mel98,michalewicz96}{8}{a,b,i}
\begin{topics}
...
\begin{unit}{Algoritmo Genético Canónico}{}{Rozenberg:2012,holland75,goldberg89,mel98,michalewicz96}{8}{a,b,i}
\begin{topics}
   \item Algoritmo Genético: definición, componentes.
   \item Algoritmo Genético Canónico: procedimiento elemental, ciclo de un AG,
         ...
         operadores genéticos (cruces, mutaciones), el dilema \textit{exploiting-exploring}, 
         ajustes en la aptitud, ajustes en la selección.
	 \item Monitoreo de un AG, curva \textit{best-so-far, online, off-line},
	 \item Convergencia
...
\begin{unit}{Algoritmos Evolutivos en Optimización Numérica}{}{Rozenberg:2012,michalewicz96,michalewicz2000,smith2000}{8}{a,b,i}
\begin{topics}
   ...
   \item Modelo GENOCOP, tratamiento de restricciones lineales, inicialización, 
         operadores, inicialización, modelo GENOCOP III para restricciones no lineales: 
...
\begin{topics}
  \item Algoritmos Evolutivos en Paralelo (PEA): arquitecturas de paralelización, arquitecturas \textit{master-slave}, \textit{coarse-grained}, \textit{fine-grained} e híbridas 
  ...
  \item Optimización de Multiples Objetivos: Definición formal, criterio de Pareto, Algoritmos Evolutivos Multi Objetivos (MOEA) sin uso de Pareto, MOEA con uso de Pareto: MOGA, NSGA, NPGA, NPGA2, PESA, SPEA, SPEA-II, Algoritmo Microgenético. 
	\item Métricas de desempeño (MOEA), investigación futura
\end{topics}
\begin{learningoutcomes}
...
\begin{unit}{Algoritmos Genéticos Avanzados}{}{Rozenberg:2012,tarek06,koza92,Reynolds94,Storn95,AbsDaCruz2007}{16}{a,b,i,j}
\begin{topics}
      \item Algoritmos Evolutivos Híbridos (HEA): Por qué hibridizar?, formas de hibridización, búsqueda local y aprendizaje.
      \item Programación Genética (GP): definición, representación, ciclo de la GP,
      \item Algoritmos Culturales (CA): Evolución Cultural, componentes, procedimiento, espacio de creencia, operadores culturales.
      \item Coevolución: carácteristicas (CoEv), modelo competitivo, modelo cooperativo.
      \item Evolución Diferencial (DE): inicialización, operaciones, selección, DE vs. GA, variantes de DE, \textit{Dynamic DE}
      \item Algoritmos Evolutivos con Inspiración Quántica (QIEA): Computación quántica, algoritmos con inspiración quántica, QIEA-\textbf{B}, QIEA-\textbf{R}
\end{topics}
