...
if($html == 1) then
    ...
    -dir "../Curricula.out/html/Peru/CS-SPC/Plan2021/" -mkdir -toc_depth 4 \
...
../Curricula.out/Peru/CS-SPC/cycle/2021-I/Plan2021/scripts/gen-dot-maps.sh;
./scripts/update-cvs-files.pl CS-SPC;
cp ../Curricula.out/Peru/CS-SPC/cycle/2021-I/Plan2021/figs/*.svg ../Curricula.out/html/Peru/CS-SPC/Plan2021/figs/.;
...
cp ../Curricula.out/pdfs/CS-SPC/Plan2021/*.png ../Curricula.out/html/Peru/CS-SPC/Plan2021/figs/.;
